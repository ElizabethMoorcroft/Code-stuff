...
for(j in 1:length(IDS)){
    ...
    #print(paste("SH:",sh))
      ...
      for(i in 0:1999){
       ...
       # print(" Erosion cal")
        ...
        if(100-100*CNTS/ALL>99.99){print("In break");break;}
        #print(paste(" End I: ",i))
      }
  #points(temp[,2:1])
  secplot<-Matrix
  ...
  #    pdf(paste("Alpha",IDS[j],".pdf",sep=""))
  #par(mfrow=c(2,1))
  #plot(smooth.spline(x=secplot[,2],y=secplot[,1], df=10), 
  #     col = COL[colournumber],type="l",
  #     ylab="Density",xlab="Proportion of time ")
  #plot(Hulls[[j]], col = COL[colournumber])
  #  box()
  #dev.off()
  }
